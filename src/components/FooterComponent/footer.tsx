      ...
      <Box
        ...
        <Container
          ...
          align={'center'}>
              ...
              <Box display='flex' justifyContent='space-between' alignItems='center'  minW={20}> 
                <Logo /> 
                <Heading textAlign='center'  fontSize={{ base: "1xl", md: "1xl" }}
              lineHeight="1.2"
              fontWeight="bold" ml='-80px'>Mauricio Dall Onder - Web Developer</Heading> 
              </Box>
         
          
          <Stack direction={'row'} spacing={6}>
            <Box as="a" href={'https://mauriciodallonder-64688.web.app/'}>
              About
            </Box>
            <Box as="a" href={'https://github.com/mauricioDallOnder'}>
              Projects
            </Box>
            <Box as="a" href={'https://www.linkedin.com/in/mauricio-dall-onder-40876a25b/'}>
              Contact
            </Box>
          </Stack>
        </Container>
        ...
        <Box
          ...
          <Container
            ...
            <Text fontSize="lg" fontWeight="bold">© 2023 Mauricio Dall Onder. All rights reserved</Text>
            <Stack direction={'row'} spacing={6}>
              <SocialButton label={'Facebook'} href={'https://www.facebook.com/mauricio.dallonder'}>
                <FaFacebook />
              </SocialButton>
              <SocialButton label={'Linkedin'} href={'https://www.linkedin.com/in/mauricio-dall-onder-40876a25b/'}>
                <FaLinkedin />
              </SocialButton>
